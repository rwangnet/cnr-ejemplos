...
<settings
 ...
 Start JBoss AS. The application will be running at the following URL:
  ...
  http://localhost:8080/capa-aplicacion-ejemplo
 ...
 You can now deploy the target/capa-aplicacion-ejemplo.war archive and launch the
 ...
 The application will be running at the following URL:
  ...
  http://localhost:7070/capa-aplicacion-ejemplo
